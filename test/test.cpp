...
{
	consequent<int, float, fuzzy::mamdani> cons1{fuzzy::mamdani<float>{}};
...
{
    consequent<int, float, mamdani> cons2{fuzzy::mamdani<float>{}};
...
{
    consequent<int, float, fuzzy::standard_additive_model> cons1{fuzzy::standard_additive_model<float>{}};
...
{
    consequent<int, float, fuzzy::standard_additive_model> cons2{fuzzy::standard_additive_model<float>{}};
    set fan_speed1 = set{ element{ 700, 0.0f },element{ 847, 0.7333333f },element{ 900, 0.7333333f },element{ 1100, 0.0f } };
    set fan_speed2 = set{ element{ 500, 0.0f },element{ 700, 0.4f },element{ 793, 0.4f },element{ 900, 0.0f } };
    cons2.aggregate(fan_speed1);
    cons2.aggregate(fan_speed2);
