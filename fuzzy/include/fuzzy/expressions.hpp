...
namespace fuzzy
{
	...
	*/
	...
	constexpr scaled_antecedent<V, M, Container, Allocator> make_antecedent(basic_set<V, M, Container, Allocator> const& value, basic_set<V, M, Container, Allocator> const& variable)
	{
		...
		// Simplify the set.
		fuzzy::detail::simplify_impl<key_type, M, Container>::apply(scaled_set); // NOTE: This is not merely a space optimization, it is for correctness with mapping rules.
